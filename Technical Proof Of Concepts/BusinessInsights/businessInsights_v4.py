...
figBar1 = dcc.Graph(
    ...
    figure=go.Figure(
        ...
        margin=dict(l=0, r=0, t=0, b=0),
        plot_bgcolor="white",  # chart plotting area
        paper_bgcolor="white",  # entire graph background
        xaxis=dict(
            title=None,
            ...
            [
                ...
                dbc.Col(
                    [
                        ...
                        dbc.Row(
                            [
                                dbc.Col(fig1, md=3, className="px-1"),
                                dbc.Col(fig2, md=3, className="px-1"),
                                dbc.Col(figSeries1, md=3, className="px-1"),
                                # dbc.Col(figBar1, md=3, className="px-1")
                            ],
                            className="g-1 mb-1",
                        ),
                        # Row 2: 3D chart
